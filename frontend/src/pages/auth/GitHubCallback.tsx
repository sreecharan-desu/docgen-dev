      ...
      try {
        ...
        if (error) {
          ...
          toast({
            ...
            description: errorDescription || "GitHub operation failed. Please try again.",
          })
        ...
        if (token) {
          ...
          window.history.replaceState({}, document.title, stateData.returnPath || '/dashboard')
        ...
        console.log("GitHubCallback: No token or code found in URL, waiting or error")
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          {status === 'error' && (
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                {errorMessage || "Failed to connect with GitHub. Redirecting..."}
              </p>
            </div>
          )}
        </div>
