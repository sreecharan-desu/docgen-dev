        ...
        <div className="container flex h-16 items-center justify-between px-4 mx-auto">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <motion.img
              ...
              whileHover={{
                scale: 1.15,
                rotate: 0, // removed the tilting keyframes
            ...
            {user ? (
              ...
              >
                ...
                <div className="flex flex-col justify-center">
                  <h2 className="text-xs font-medium text-white leading-tight truncate max-w-32">
                    {user?.name || "User"}
                  </h2>
                ...
                {!user ? (
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-4">
                      <Link to="/auth/login">
                        <Button
                          variant="outline"
                          size="sm"
                          className="w-full border-gray-700 hover:bg-primary/80 hover:border-primary hover:text-primary"
                        >
                          Join us
                        </Button>
                      </Link>
                  ...
                  <>
                    ...
                    >
                      <Link
                        to="/dashboard"
                        className="block py-3 flex items-center gap-2 text-white hover:text-primary"
                      >
